...
while True:
    if 0 <= num <= 20:
        print(f'Você digitou o número {tupla[num].upper()}.')
        resp = input(f'Quer digitar mais um número? [S/N] ').lower()
        if resp == 'n':
            break
    num = int(input('Digite um número inteiro de 0 a 20: '))
...
tupla2 = ('zero', 'um', 'dois', 'três', 'quatro', 'cinco', 'seis', 'sete', 
'oito', 'nove', 'dez', 'onze', 'doze', 'treze', 'quatorze', 'quinze', 'dezesseis', 
'dezessete', 'dezoito', 'dezenove', 'vinte')
num = int(input('Digite um número inteiro de 0 a 20: '))
while True:
    if num in tupla1:
        print(f'Você digitou o número {tupla2[num]}.')
        break
    num = int(input('Digite um número inteiro de 0 a 20: '))
...
tupla = ('zero', 0, 'um', 1, 'dois', 2, 'três', 3, 'quatro', 4, 'cinco', 5, 
