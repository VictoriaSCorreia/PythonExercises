...
brasileirao = ('Palmeiras', 'Internacional', 'Fluminense', 
'Corinthians', 'Flamengo', 'Atlético-PR', 'Atlético-MG', 'Fortaleza', 
'São Paulo', 'América-MG', 'Botafogo', 'Santos', 'Goiás', 'Bragantino', 
...
for c in brasileirao[-4:]:
    print(c)
print(f'Em ordem alfabética:\n {sorted(brasileirao)}')
if 'Chapecoense' in brasileirao:
    print(f'O time da Chapecoense está na {brasileirao.index("Chapecoense")+1}° posição.')
else:
